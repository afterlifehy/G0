...
import ja.insepector.bxapp.adapter.DebtCollectionAdapter
import ja.insepector.bxapp.databinding.ActivityDebtCollectionBinding
import ja.insepector.bxapp.mvvm.viewmodel.DebtCollectionViewModel
...
class DebtCollectionActivity : VbBaseActivity<DebtCollectionViewModel, ActivityDebtCollectionBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        binding.layoutToolbar.tvTitle.text = i18N(ja.insepector.base.R.string.欠费追缴)
        ...
        GlideUtils.instance?.loadImage(binding.layoutNoData.ivNoData, ja.insepector.common.R.mipmap.ic_no_data_2)
        binding.layoutNoData.tvNoDataTitle.text = i18N(ja.insepector.base.R.string.通过车牌号未查询到欠费订单)
