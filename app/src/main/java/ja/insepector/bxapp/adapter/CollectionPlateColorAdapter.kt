...
class CollectionPlateColorAdapter(val widthType: Int, data: MutableList<String>? = null, val onClickListener: OnClickListener) :
    ...
    init {
        collectioPlateColorMap[Constant.BLUE] = ja.insepector.common.R.mipmap.ic_plate_blue
        collectioPlateColorMap[Constant.GREEN] = ja.insepector.common.R.mipmap.ic_plate_green
        collectioPlateColorMap[Constant.YELLOW] = ja.insepector.common.R.mipmap.ic_plate_yellow
        collectioPlateColorMap[Constant.YELLOW_GREEN] = ja.insepector.common.R.mipmap.ic_plate_yellow_green
        collectioPlateColorMap[Constant.WHITE] = ja.insepector.common.R.mipmap.ic_plate_white
        collectioPlateColorMap[Constant.BLACK] = ja.insepector.common.R.mipmap.ic_plate_black
        collectioPlateColorMap[Constant.OTHERS] = ja.insepector.common.R.mipmap.ic_plate_other
    }
