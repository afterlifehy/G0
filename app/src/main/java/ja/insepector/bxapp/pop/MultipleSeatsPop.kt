...
class MultipleSeatsPop(
    ...
    private fun initView() {
        ...
        when (multipleSeat) {
            "" -> {
                GlideUtils.instance?.loadImage(binding.ivParkingNoNone, ja.insepector.common.R.mipmap.ic_parking_street_checked)
            }

            frontSeat -> {
                GlideUtils.instance?.loadImage(binding.ivParkingNo, ja.insepector.common.R.mipmap.ic_parking_street_checked)
            }

            behindSeat -> {
                GlideUtils.instance?.loadImage(binding.ivParkingNo2, ja.insepector.common.R.mipmap.ic_parking_street_checked)
            }
        }
