...
import com.kernal.demo.base.ext.i18n
import com.kernal.demo.plateid.adapter.TransactionInquiryAdapter
import com.kernal.demo.plateid.databinding.ActivityTransactionInquiryBinding
import com.kernal.demo.plateid.mvvm.viewmodel.TransactionInquiryViewModel
...
class TransactionInquiryActivity : VbBaseActivity<TransactionInquiryViewModel, ActivityTransactionInquiryBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        binding.layoutToolbar.tvTitle.text = i18N(com.kernal.demo.base.R.string.交易查询)
    ...
    override fun initListener() {
        ...
        ClickUtils.applySingleDebouncing(binding.tvSearch, 3000, this)
