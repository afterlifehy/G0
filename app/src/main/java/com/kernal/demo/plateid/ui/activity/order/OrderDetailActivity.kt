...
import com.kernal.demo.plateid.databinding.ActivityOrderDetailBinding
import com.kernal.demo.plateid.mvvm.viewmodel.OrderDetailViewModel
...
class OrderDetailActivity : VbBaseActivity<OrderDetailViewModel, ActivityOrderDetailBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        binding.layoutToolbar.tvTitle.text = i18N(com.kernal.demo.base.R.string.订单详细信息)
        ...
        val strings2 = arrayOf(i18N(com.kernal.demo.base.R.string.泊位) + "：", order?.parkingNo.toString())
        binding.tvBerth.text = AppUtil.getSpan(strings2, sizes2, colors2)
        val strings3 = arrayOf(i18N(com.kernal.demo.base.R.string.路段) + "：", order?.streetName.toString())
        binding.tvStreet.text = AppUtil.getSpan(strings3, sizes2, colors2)
        val strings4 = arrayOf(i18N(com.kernal.demo.base.R.string.入场) + "：", order?.startTime.toString())
        ...
        val strings6 = arrayOf(i18N(com.kernal.demo.base.R.string.时长) + "：", AppUtil.millisToDate(order?.duration2!!.toLong() * 1000L))
