...
class AdmissionTakePhotoActivity : VbBaseActivity<AdmissionTakePhotoViewModel, ActivityAdmissionTakePhotoBinding>(), OnClickListener {
    ...
    override fun initListener() {
        ...
        ClickUtils.applySingleDebouncing(binding.ivRecognize,3000,this@AdmissionTakePhotoActivity)
        ClickUtils.applySingleDebouncing(binding.rflTakePhoto,3000,this@AdmissionTakePhotoActivity)
        ClickUtils.applySingleDebouncing(binding.rflTakePhoto2,3000,this@AdmissionTakePhotoActivity)
        ClickUtils.applySingleDebouncing(binding.rivPlate,3000,this@AdmissionTakePhotoActivity)
        ClickUtils.applySingleDebouncing(binding.rivPanorama,3000,this@AdmissionTakePhotoActivity)
