    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (keys != null && keys.size > 0) {
            ...
            for (key in keys) {
                ...
                if (key.codes[0] == -4) {
                    paint.setColor(getContext().getResources().getColor(ja.insepector.base.R.color.white));
                    val rect = RectF(
                        key.x.toFloat(),
                        key.y.toFloat() + SizeUtils.dp2px(10f),
                        (
                    ...
                    paint.setColor(getContext().getResources().getColor(ja.insepector.base.R.color.black));
