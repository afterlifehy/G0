    ...
    fun zkblueprint(content: String) {
        ...
        try {
            ...
            Handler(Looper.getMainLooper()).post {
                DialogHelp.Builder().setTitle(i18n(ja.insepector.base.R.string.打印机状态异常请重新连接))
        ...
        if (printText !== "" && printText != null) {
            ...
            if (receipt) {
                ...
                zpSDK!!.drawGraphic(
                    ...
                    300,
                    300,
                    BitmapFactory.decodeResource(BaseApplication.instance().resources, ja.insepector.common.R.mipmap.ic_print_qr)
                )
